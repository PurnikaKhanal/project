...
protected:
    ...
    float calories;
    float BMR;
    string goal; // New variable to store the goal
...
public:
    ...
    void showdata() {
        ...
        cout << "Personal Goal: " << goal << endl; // Show the goal
    }
    ...
    void setGoal() {
        cout << "Enter your personal goal:" << endl;
        ...
        if (file.is_open()) {
            ...
            cout << "Failed to open file for writing goal." << endl;
        }
    }

    void changeGoal() {
        cout << "Enter your new personal goal:" << endl;
        cin.ignore(); // Clear the newline character from the input buffer
        getline(cin, goal);
        ofstream file("goal.txt");
        if (file.is_open()) {
            file << goal << endl;
            file.close();
            cout << "Goal changed successfully!" << endl;
        } else {
            cout << "Failed to open file for writing goal." << endl;
        }
    }
    ...
    void showGoal() {
        ...
        if (file.is_open()) {
            getline(file, goal);
            cout << "Your current goal is: " << goal << endl;
            file.close();
        } else {
            cout << "No goal set yet." << endl;
        }
    }
    ...
    void displayQuote() {
        ...
        cout << "Quote of the day: " << quotes[randomIndex] << endl;
    }
};
